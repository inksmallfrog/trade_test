...
module.exports = class{
    ...
    async calPosition(){
	    ...
	    await Position.update(key, this.positions[key]);
        }
    }
    ...
    async queryPositionFromAPI(){
		...
		this.positions[coin.currency].usdtInvested = this.positions[coin.currency].cost * coin.balance;
            }
        })
    }
	...
	if(this.usdtAvailable - newInvested < 0){
	    strategyLogger.info('refuse to buy! no money!');
	    return false;
	}
